...
# mkdir datasets/ImageNet/train && mv ILSVRC2012_img_train.tar datasets/ImageNet/train/ #&& cd imagenet/train
...
mkdir datasets/ImageNet/val && mv datasets/ImageNet/ILSVRC2012_img_val.tar datasets/ImageNet/val/ && cd datasets/ImageNet/val && tar -xvf ILSVRC2012_img_val.tar #&& rm -f ILSVRC2012_img_val.tar
